...
const { findAllStudents, findStudentDetail, findStudentToSetStatus, addOrUpdateStudent, deleteStudent: deleteStudentFromRepo } = require("./students-repository");
...
const deleteStudent = async (payload) => {
    ...
    const affectedRow = await deleteStudentFromRepo(payload);
    if (affectedRow <= 0) {
